...
class GameView {
  ...
  drawPaused(){
    ...
    this.ctx.fillText("Main Menu", 400, 240);
    this.ctx.font = "50px PixelEmulator";
    this.ctx.fillText("Controls:", 480, 310);
    this.ctx.font = "30px PixelEmulator";
    this.ctx.fillText(`Space to shoot`, 480, 360);
    this.ctx.fillText(`LUDR Arrows to steer`, 430, 410);
    this.ctx.fillText(`Esc / Enter to pause`, 450, 460)
    // this.ctx.fillText("PAUSED", 400, 350);
  }
